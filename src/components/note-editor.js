    ...
    return(
        <div className="half-width flex flex-column gap-s">
            ...
            <div className="flex gap-m">
                <button className="btn btn-secondary" onClick={() => addNote({title,body,colour,priority,labels : labels.length > 0 ? [...labels] : ["None"]},userDispatch,notesDispatch)}>Add Note</button>
